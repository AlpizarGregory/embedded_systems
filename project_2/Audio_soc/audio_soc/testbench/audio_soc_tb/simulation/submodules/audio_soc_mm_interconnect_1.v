...
`timescale 1 ps / 1 ps
module audio_soc_mm_interconnect_1 (
		...
		output wire [14:0] SHARED_MEMORY_s1_address,                                         //                                           SHARED_MEMORY_s1.address
	...
	wire   [29:0] shared_memory_s1_agent_m0_address;                           // SHARED_MEMORY_s1_agent:m0_address -> SHARED_MEMORY_s1_translator:uav_address
	...
	wire  [123:0] shared_memory_s1_agent_rf_source_data;                       // SHARED_MEMORY_s1_agent:rf_source_data -> SHARED_MEMORY_s1_agent_rsp_fifo:in_data
	...
	wire  [123:0] shared_memory_s1_agent_rsp_fifo_out_data;                    // SHARED_MEMORY_s1_agent_rsp_fifo:out_data -> SHARED_MEMORY_s1_agent:rf_sink_data
	...
	wire          shared_memory_s1_agent_rdata_fifo_src_valid;                 // SHARED_MEMORY_s1_agent:rdata_fifo_src_valid -> SHARED_MEMORY_s1_agent_rdata_fifo:in_valid
	wire   [33:0] shared_memory_s1_agent_rdata_fifo_src_data;                  // SHARED_MEMORY_s1_agent:rdata_fifo_src_data -> SHARED_MEMORY_s1_agent_rdata_fifo:in_data
	wire          shared_memory_s1_agent_rdata_fifo_src_ready;                 // SHARED_MEMORY_s1_agent_rdata_fifo:in_ready -> SHARED_MEMORY_s1_agent:rdata_fifo_src_ready
	...
	wire          shared_memory_s1_agent_rp_valid;                             // SHARED_MEMORY_s1_agent:rp_valid -> router_004:sink_valid
	wire  [122:0] shared_memory_s1_agent_rp_data;                              // SHARED_MEMORY_s1_agent:rp_data -> router_004:sink_data
	wire          shared_memory_s1_agent_rp_ready;                             // router_004:sink_ready -> SHARED_MEMORY_s1_agent:rp_ready
	wire          shared_memory_s1_agent_rp_startofpacket;                     // SHARED_MEMORY_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          shared_memory_s1_agent_rp_endofpacket;                       // SHARED_MEMORY_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                           // cmd_mux:src_valid -> SHARED_MEMORY_s1_burst_adapter:sink0_valid
	wire  [122:0] cmd_mux_src_data;                                            // cmd_mux:src_data -> SHARED_MEMORY_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                           // SHARED_MEMORY_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [3:0] cmd_mux_src_channel;                                         // cmd_mux:src_channel -> SHARED_MEMORY_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                   // cmd_mux:src_startofpacket -> SHARED_MEMORY_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                     // cmd_mux:src_endofpacket -> SHARED_MEMORY_s1_burst_adapter:sink0_endofpacket
	wire          shared_memory_s1_burst_adapter_source0_valid;                // SHARED_MEMORY_s1_burst_adapter:source0_valid -> SHARED_MEMORY_s1_agent:cp_valid
	wire  [122:0] shared_memory_s1_burst_adapter_source0_data;                 // SHARED_MEMORY_s1_burst_adapter:source0_data -> SHARED_MEMORY_s1_agent:cp_data
	wire          shared_memory_s1_burst_adapter_source0_ready;                // SHARED_MEMORY_s1_agent:cp_ready -> SHARED_MEMORY_s1_burst_adapter:source0_ready
	wire    [3:0] shared_memory_s1_burst_adapter_source0_channel;              // SHARED_MEMORY_s1_burst_adapter:source0_channel -> SHARED_MEMORY_s1_agent:cp_channel
	wire          shared_memory_s1_burst_adapter_source0_startofpacket;        // SHARED_MEMORY_s1_burst_adapter:source0_startofpacket -> SHARED_MEMORY_s1_agent:cp_startofpacket
	wire          shared_memory_s1_burst_adapter_source0_endofpacket;          // SHARED_MEMORY_s1_burst_adapter:source0_endofpacket -> SHARED_MEMORY_s1_agent:cp_endofpacket
	...
	wire          shared_memory_s1_agent_rdata_fifo_out_valid;                 // SHARED_MEMORY_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] shared_memory_s1_agent_rdata_fifo_out_data;                  // SHARED_MEMORY_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          shared_memory_s1_agent_rdata_fifo_out_ready;                 // avalon_st_adapter:in_0_ready -> SHARED_MEMORY_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                               // avalon_st_adapter:out_0_valid -> SHARED_MEMORY_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                // avalon_st_adapter:out_0_data -> SHARED_MEMORY_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                               // SHARED_MEMORY_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                               // avalon_st_adapter:out_0_error -> SHARED_MEMORY_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (shared_memory_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (shared_memory_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (shared_memory_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (shared_memory_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (shared_memory_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (shared_memory_s1_burst_adapter_source0_channel),       //                .channel
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) shared_memory_s1_agent_rdata_fifo (
		.clk               (sys_sdram_pll_0_sys_clk_clk),                      //       clk.clk
		.reset             (SHARED_MEMORY_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (shared_memory_s1_agent_rdata_fifo_src_data),       //        in.data
		.in_valid          (shared_memory_s1_agent_rdata_fifo_src_valid),      //          .valid
		.in_ready          (shared_memory_s1_agent_rdata_fifo_src_ready),      //          .ready
		.out_data          (shared_memory_s1_agent_rdata_fifo_out_data),       //       out.data
		.out_valid         (shared_memory_s1_agent_rdata_fifo_out_valid),      //          .valid
		.out_ready         (shared_memory_s1_agent_rdata_fifo_out_ready),      //          .ready
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	audio_soc_mm_interconnect_1_router router (
	...
	audio_soc_mm_interconnect_1_router router_001 (
	...
	audio_soc_mm_interconnect_1_router_002 router_002 (
	...
	audio_soc_mm_interconnect_1_router_002 router_003 (
	...
	audio_soc_mm_interconnect_1_router_004 router_004 (
	...
	altera_merlin_burst_adapter #(
	...
	) shared_memory_s1_burst_adapter (
		.clk                   (sys_sdram_pll_0_sys_clk_clk),                          //       cr0.clk
		.reset                 (SHARED_MEMORY_reset1_reset_bridge_in_reset_reset),     // cr0_reset.reset
		...
		.source0_valid         (shared_memory_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (shared_memory_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (shared_memory_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (shared_memory_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (shared_memory_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (shared_memory_s1_burst_adapter_source0_ready)          //          .ready
	);

	audio_soc_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                                      //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audio_soc_mm_interconnect_1_cmd_demux cmd_demux_001 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                                      //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audio_soc_mm_interconnect_1_cmd_demux cmd_demux_002 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                                      //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audio_soc_mm_interconnect_1_cmd_demux cmd_demux_003 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                                      //       clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audio_soc_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                      //       clk.clk
		.reset               (SHARED_MEMORY_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audio_soc_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                      //       clk.clk
		.reset              (SHARED_MEMORY_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audio_soc_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                                      //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audio_soc_mm_interconnect_1_rsp_mux rsp_mux_001 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                                      //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audio_soc_mm_interconnect_1_rsp_mux rsp_mux_002 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                                      //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audio_soc_mm_interconnect_1_rsp_mux rsp_mux_003 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                                      //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	audio_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (shared_memory_s1_agent_rdata_fifo_out_data),       //     in_0.data
		.in_0_valid     (shared_memory_s1_agent_rdata_fifo_out_valid),      //         .valid
		.in_0_ready     (shared_memory_s1_agent_rdata_fifo_out_ready),      //         .ready
