...
// role:width:direction:                              mem_a:13:input,mem_ba:3:input,mem_cas_n:1:input,mem_ck:1:input,mem_ck_n:1:input,mem_cke:1:input,mem_cs_n:1:input,mem_dm:1:input,mem_dq:8:bidir,mem_dqs:1:bidir,mem_dqs_n:1:bidir,mem_odt:1:input,mem_ras_n:1:input,mem_reset_n:1:input,mem_we_n:1:input,oct_rzqin:1:output
// 0
//-----------------------------------------------------------------------------
`timescale 1 ps / 1 ps
...
(
   ...
   logic [12 : 0] sig_mem_a_in;
   logic [12 : 0] sig_mem_a_local;
   ...
   logic [0 : 0] sig_mem_dm_in;
   logic [0 : 0] sig_mem_dm_local;
   logic sig_mem_dq_oe;
