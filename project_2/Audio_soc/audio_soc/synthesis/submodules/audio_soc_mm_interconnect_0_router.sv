...
module audio_soc_mm_interconnect_0_router_default_decode
  #(
...
module audio_soc_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD10 = log2ceil(64'h1108c - 64'h11088); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h1108c;
    ...
    audio_soc_mm_interconnect_0_router_default_decode the_default_decode(
    ...
    // ( 0x11088 .. 0x1108c )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 17'h11088  && read_transaction  ) begin
