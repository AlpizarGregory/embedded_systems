...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/audio_soc_hps_0_fpga_interfaces_h2f_mpu_events.sv" -work fpga_interfaces           -cdslib ./cds_libs/fpga_interfaces.cds.lib          
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/audio_soc_hps_0_fpga_interfaces.sv"                -work fpga_interfaces           -cdslib ./cds_libs/fpga_interfaces.cds.lib          
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_NIOSII_cpu.v"                            -work cpu                       -cdslib ./cds_libs/cpu.cds.lib                      
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_NIOSII_cpu_debug_slave_sysclk.v"         -work cpu                       -cdslib ./cds_libs/cpu.cds.lib                      
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_NIOSII_cpu_debug_slave_tck.v"            -work cpu                       -cdslib ./cds_libs/cpu.cds.lib                      
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_NIOSII_cpu_debug_slave_wrapper.v"        -work cpu                       -cdslib ./cds_libs/cpu.cds.lib                      
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_NIOSII_cpu_test_bench.v"                 -work cpu                       -cdslib ./cds_libs/cpu.cds.lib                      
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_AUDIO_PLL_audio_pll.vo"                  -work audio_pll                 -cdslib ./cds_libs/audio_pll.cds.lib                
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/audio_soc_irq_mapper.sv"                           -work irq_mapper                -cdslib ./cds_libs/irq_mapper.cds.lib               
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_mm_interconnect_0.v"                     -work mm_interconnect_0         -cdslib ./cds_libs/mm_interconnect_0.cds.lib        
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_hps_0.v"                                 -work hps_0                     -cdslib ./cds_libs/hps_0.cds.lib                    
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_TIMER.v"                                 -work TIMER                     -cdslib ./cds_libs/TIMER.cds.lib                    
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_SEVEN_SEGMENTS.v"                        -work SEVEN_SEGMENTS            -cdslib ./cds_libs/SEVEN_SEGMENTS.cds.lib           
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_RAM.v"                                   -work RAM                       -cdslib ./cds_libs/RAM.cds.lib                      
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_NIOSII.v"                                -work NIOSII                    -cdslib ./cds_libs/NIOSII.cds.lib                   
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_JTAG_UART.v"                             -work JTAG_UART                 -cdslib ./cds_libs/JTAG_UART.cds.lib                
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_FIFO.v"                                  -work FIFO                      -cdslib ./cds_libs/FIFO.cds.lib                     
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_BUTTON_1.v"                              -work BUTTON_1                  -cdslib ./cds_libs/BUTTON_1.cds.lib                 
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_AUDIO_PLL.v"                             -work AUDIO_PLL                 -cdslib ./cds_libs/AUDIO_PLL.cds.lib                
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_up_av_config_serial_bus_controller.v"       -work AUDIO_CONFIG              -cdslib ./cds_libs/AUDIO_CONFIG.cds.lib             
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_up_slow_clock_generator.v"                  -work AUDIO_CONFIG              -cdslib ./cds_libs/AUDIO_CONFIG.cds.lib             
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_up_av_config_auto_init.v"                   -work AUDIO_CONFIG              -cdslib ./cds_libs/AUDIO_CONFIG.cds.lib             
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_up_av_config_auto_init_dc2.v"               -work AUDIO_CONFIG              -cdslib ./cds_libs/AUDIO_CONFIG.cds.lib             
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_up_av_config_auto_init_d5m.v"               -work AUDIO_CONFIG              -cdslib ./cds_libs/AUDIO_CONFIG.cds.lib             
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_up_av_config_auto_init_lcm.v"               -work AUDIO_CONFIG              -cdslib ./cds_libs/AUDIO_CONFIG.cds.lib             
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_up_av_config_auto_init_ltm.v"               -work AUDIO_CONFIG              -cdslib ./cds_libs/AUDIO_CONFIG.cds.lib             
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_up_av_config_auto_init_ob_de1_soc.v"        -work AUDIO_CONFIG              -cdslib ./cds_libs/AUDIO_CONFIG.cds.lib             
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_up_av_config_auto_init_ob_de2_115.v"        -work AUDIO_CONFIG              -cdslib ./cds_libs/AUDIO_CONFIG.cds.lib             
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_up_av_config_auto_init_ob_de2i_150.v"       -work AUDIO_CONFIG              -cdslib ./cds_libs/AUDIO_CONFIG.cds.lib             
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_up_av_config_auto_init_ob_de10_standard.v"  -work AUDIO_CONFIG              -cdslib ./cds_libs/AUDIO_CONFIG.cds.lib             
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_up_av_config_auto_init_ob_audio.v"          -work AUDIO_CONFIG              -cdslib ./cds_libs/AUDIO_CONFIG.cds.lib             
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_up_av_config_auto_init_ob_adv7180.v"        -work AUDIO_CONFIG              -cdslib ./cds_libs/AUDIO_CONFIG.cds.lib             
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_up_av_config_auto_init_ob_adv7181.v"        -work AUDIO_CONFIG              -cdslib ./cds_libs/AUDIO_CONFIG.cds.lib             
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_AUDIO_CONFIG.v"                          -work AUDIO_CONFIG              -cdslib ./cds_libs/AUDIO_CONFIG.cds.lib             
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/audio_soc_AUDIO.v"                                 -work AUDIO                     -cdslib ./cds_libs/AUDIO.cds.lib                    
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/audio_soc.v"                                                                                                                                      
fi
