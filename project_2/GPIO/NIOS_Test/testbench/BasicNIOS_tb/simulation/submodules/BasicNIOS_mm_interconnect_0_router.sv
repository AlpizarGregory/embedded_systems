...
module BasicNIOS_mm_interconnect_0_router_default_decode
  #(
...
module BasicNIOS_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    BasicNIOS_mm_interconnect_0_router_default_decode the_default_decode(
