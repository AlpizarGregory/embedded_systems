...
`timescale 1 ps / 1 ps
module BasicNIOS_mm_interconnect_0 (
	...
	wire  [90:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> NIOS_data_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                          // NIOS_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [6:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> NIOS_data_master_agent:rp_channel
	...
	wire  [90:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> NIOS_instruction_master_agent:rp_data
	wire         rsp_mux_001_src_ready;                                                      // NIOS_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire   [6:0] rsp_mux_001_src_channel;                                                    // rsp_mux_001:src_channel -> NIOS_instruction_master_agent:rp_channel
	...
	wire  [91:0] nios_debug_mem_slave_agent_rf_source_data;                                  // NIOS_debug_mem_slave_agent:rf_source_data -> NIOS_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [91:0] nios_debug_mem_slave_agent_rsp_fifo_out_data;                               // NIOS_debug_mem_slave_agent_rsp_fifo:out_data -> NIOS_debug_mem_slave_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> NIOS_debug_mem_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                      // NIOS_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [6:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> NIOS_debug_mem_slave_agent:cp_channel
	...
	wire  [91:0] timer_s1_agent_rf_source_data;                                              // TIMER_s1_agent:rf_source_data -> TIMER_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] timer_s1_agent_rsp_fifo_out_data;                                           // TIMER_s1_agent_rsp_fifo:out_data -> TIMER_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> TIMER_s1_agent:cp_data
	...
	wire   [6:0] cmd_mux_004_src_channel;                                                    // cmd_mux_004:src_channel -> LEDS_s1_agent:cp_channel
	...
	wire  [14:0] gpio_s1_agent_m0_address;                                                   // GPIO_s1_agent:m0_address -> GPIO_s1_translator:uav_address
	...
	wire  [91:0] gpio_s1_agent_rf_source_data;                                               // GPIO_s1_agent:rf_source_data -> GPIO_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] gpio_s1_agent_rsp_fifo_out_data;                                            // GPIO_s1_agent_rsp_fifo:out_data -> GPIO_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                      // cmd_mux_005:src_valid -> GPIO_s1_agent:cp_valid
	wire  [90:0] cmd_mux_005_src_data;                                                       // cmd_mux_005:src_data -> GPIO_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                      // GPIO_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                    // cmd_mux_005:src_channel -> GPIO_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                              // cmd_mux_005:src_startofpacket -> GPIO_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                // cmd_mux_005:src_endofpacket -> GPIO_s1_agent:cp_endofpacket
	...
	wire  [91:0] switch_s1_agent_rf_source_data;                                             // SWITCH_s1_agent:rf_source_data -> SWITCH_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] switch_s1_agent_rsp_fifo_out_data;                                          // SWITCH_s1_agent_rsp_fifo:out_data -> SWITCH_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_006_src_data;                                                       // cmd_mux_006:src_data -> SWITCH_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                      // SWITCH_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                    // cmd_mux_006:src_channel -> SWITCH_s1_agent:cp_channel
	...
	wire  [90:0] nios_data_master_agent_cp_data;                                             // NIOS_data_master_agent:cp_data -> router:sink_data
	...
	wire  [90:0] nios_instruction_master_agent_cp_data;                                      // NIOS_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [90:0] nios_debug_mem_slave_agent_rp_data;                                         // NIOS_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [90:0] timer_s1_agent_rp_data;                                                     // TIMER_s1_agent:rp_data -> router_005:sink_data
	...
	wire         gpio_s1_agent_rp_valid;                                                     // GPIO_s1_agent:rp_valid -> router_007:sink_valid
	wire  [90:0] gpio_s1_agent_rp_data;                                                      // GPIO_s1_agent:rp_data -> router_007:sink_data
	wire         gpio_s1_agent_rp_ready;                                                     // router_007:sink_ready -> GPIO_s1_agent:rp_ready
	wire         gpio_s1_agent_rp_startofpacket;                                             // GPIO_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         gpio_s1_agent_rp_endofpacket;                                               // GPIO_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [90:0] switch_s1_agent_rp_data;                                                    // SWITCH_s1_agent:rp_data -> router_008:sink_data
	...
	wire         gpio_s1_agent_rdata_fifo_src_valid;                                         // GPIO_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] gpio_s1_agent_rdata_fifo_src_data;                                          // GPIO_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         gpio_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_005:in_0_ready -> GPIO_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                          // avalon_st_adapter_005:out_0_valid -> GPIO_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                           // avalon_st_adapter_005:out_0_data -> GPIO_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                          // GPIO_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                          // avalon_st_adapter_005:out_0_error -> GPIO_s1_agent:rdata_fifo_sink_error
	...
	BasicNIOS_mm_interconnect_0_router router (
	...
	BasicNIOS_mm_interconnect_0_router_001 router_001 (
	...
	BasicNIOS_mm_interconnect_0_router_002 router_002 (
	...
	BasicNIOS_mm_interconnect_0_router_003 router_003 (
	...
	BasicNIOS_mm_interconnect_0_router_003 router_004 (
	...
	BasicNIOS_mm_interconnect_0_router_002 router_005 (
	...
	BasicNIOS_mm_interconnect_0_router_002 router_006 (
	...
	BasicNIOS_mm_interconnect_0_router_002 router_007 (
	...
	BasicNIOS_mm_interconnect_0_router_002 router_008 (
	...
	BasicNIOS_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	BasicNIOS_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
